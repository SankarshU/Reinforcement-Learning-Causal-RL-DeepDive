...
class gumble_max_scm_process:
    def __init__(self,cql_agent,obs_arr,matrix_to_seq_dct,r_mat_full,tx_mat_full,n_cf_samps=5):
        gmcm=gumble_max_scm()
    ...
    def cf_trajectories_generation(self,n_draws=1000):
        print(f"batch trajectories shape: {obs_arr.shape}")
        #n_cf_samps=1
        tqdm_desc='CF OPE'
        batch=obs_arr
